...
if __name__ == '__main__':
    ...
    # n_shape_var = 20
    num_shapevar = [20]
    for n_shape_var in num_shapevar:
        experiment_folder_list = \
            [f'/home/abhiroop/Insync/ghoshab1@msu.edu/Google Drive/Abhiroop/Data/MSU/Research/DARPA/Code/CP3/'
             f'TrussResults/truss_nsga2_20200510/symm_{n_shape_var}_shape_base',
             f'/home/abhiroop/Insync/ghoshab1@msu.edu/Google Drive/Abhiroop/Data/MSU/Research/DARPA/Code/CP3/'
             f'TrussResults/truss_nsga2_20200510/symm_{n_shape_var}_shape_repair',
             f'/home/abhiroop/Insync/ghoshab1@msu.edu/Google Drive/Abhiroop/Data/MSU/Research/DARPA/Code/CP3/'
             f'TrussResults/truss_nsga2_20200510/symm_{n_shape_var}_shape_repair_momentum']

        coordinates, connectivity, fixed_nodes, load_nodes, member_groups \
            = gen_truss(n_shape_nodes=2*n_shape_var - 1)
        for output_folder in experiment_folder_list:
            ...
            gen_arr = [100, 500, 1000, 2000]
            modified_gen_arr = [100, 500, 1000, 2000]
            # gen_arr = [100, 110, 120]
            # modified_gen_arr = gen_arr
            # gen_arr = [400]
